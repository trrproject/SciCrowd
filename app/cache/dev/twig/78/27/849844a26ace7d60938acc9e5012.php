...
/* ObsCoreBundle:Publisher:new.html.twig */
class __TwigTemplate_7827849844a26ace7d60938acc9e5012 extends Twig_Template
{
    ...
    {
        // line 4
        echo "<h1>Publisher creation</h1>

    <form action=\"";
        // line 6
        echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("publisher_create"), "html", null, true);
        echo "\" method=\"post\" ";
...
";
    ...
    {
        return "ObsCoreBundle:Publisher:new.html.twig";
    }
