...
class Notes
{
    ...
    /**
     * @var \Obs\SecurityBundle\Entity\Users
     *
     * @ORM\ManyToOne(targetEntity="Obs\SecurityBundle\Entity\Users", inversedBy="notes")
     * @ORM\JoinColumns({
     ...
     * Set users
     *
     * @param \Obs\SecurityBundle\Entity\Users $users
     * @return Notes
     */
    public function setUsers(\Obs\SecurityBundle\Entity\Users $users = null)
    {
        $this->users = $users;
