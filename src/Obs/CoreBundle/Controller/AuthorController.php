...
use Obs\CoreBundle\Entity\Author;
use Obs\CoreBundle\Form\AuthorType;
...
class AuthorController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('ObsCoreBundle:Author')->findAll();

        return $this->render('ObsCoreBundle:Author:index.html.twig', array(
            'entities' => $entities,
        ));
    }
    ...
    public function createAction(Request $request)
    {
        ...
        return $this->render('ObsCoreBundle:Author:new.html.twig', array(
            'entity' => $entity,
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('ObsCoreBundle:Author')->find($id);
        ...
        return $this->render('ObsCoreBundle:Author:show.html.twig', array(
            'entity'      => $entity,
    ...
    public function editAction($id)
    {
        ...
        return $this->render('ObsCoreBundle:Author:edit.html.twig', array(
            'entity'      => $entity,
