...
use Obs\SecurityBundle\Entity\Groups;
use Obs\SecurityBundle\Form\GroupsType;
...
class GroupsController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('ObsSecurityBundle:Groups')->findAll();

        return $this->render('ObsSecurityBundle:Groups:index.html.twig', array(
            'entities' => $entities,
        ));
    }
    ...
    public function createAction(Request $request)
    {
        ...
        return $this->render('ObsSecurityBundle:Groups:new.html.twig', array(
            'entity' => $entity,
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('ObsSecurityBundle:Groups')->find($id);
        ...
        return $this->render('ObsSecurityBundle:Groups:show.html.twig', array(
            'entity'      => $entity,
    ...
    public function editAction($id)
    {
        ...
        return $this->render('ObsSecurityBundle:Groups:edit.html.twig', array(
            'entity'      => $entity,
